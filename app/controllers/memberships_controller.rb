class MembershipsController < ApplicationController
  ...
  def create
    ...
    if Membership.find_by(user_id: @membership.user_id, beer_club_id: @membership.beer_club_id)
      redirect_to new_membership_path, notice: "User is already a member of this club"
      return
    end
